...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Relation<'manyToOne', 'api::article.category'>;
    commentable: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    slug: Schema.Attribute.String &
      ...
      Schema.Attribute.CustomField<
        'plugin::pinyin-slug.pinyin-slug',
        {
          sourceField: 'title';
        }
      >;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::article.tag'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    unlisted: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiArticleCategory extends Struct.CollectionTypeSchema {
...
export interface ApiArticleTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::article.tag'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    metadataNextLayout: Schema.Attribute.JSON &
      Schema.Attribute.DefaultTo<{
        alternates: {
          canonical: '/';
          languages: {
        ...
        creator: 'Jiachi Liu';
        description: 'A blog demo using Strapi as headless CMS and Next.js as frontend with static site generation (SSG)';
        formatDetection: {
          address: false;
          email: false;
          telephone: false;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::article.category': ApiArticleCategory;
      'api::article.tag': ApiArticleTag;
